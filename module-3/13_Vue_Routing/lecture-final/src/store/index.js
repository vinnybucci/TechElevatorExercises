...
export default new Vuex.Store({
  ...
  mutations: {
    ADD_REVIEW(state,reviewInput) {
      const product = this.state.products.find(p => p.id == reviewInput.productID);
      reviewInput.review.id = product.reviews.length;
      product.reviews.unshift(reviewInput.review);
    },
