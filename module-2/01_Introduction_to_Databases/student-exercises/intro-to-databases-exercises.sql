...
select name, population from city where countrycode = 'USA' and population > 1000000 and population < 2000000
...
select gnp, population, (gnp/population) *1000000 as percapita from country where continent = 'Europe'
-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
select indepyear from country where indepyear is not null  